...
Encontramos un archivo interesante que es -> **penguin.html**. Accedemos a él para ver que nos encontramos:
...
Encontramos la contraseña -> **password1** Ahora ya lo podemos abrir:
